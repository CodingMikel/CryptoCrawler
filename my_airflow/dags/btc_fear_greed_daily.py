...
@dag(
    ...
    description='Fear and Greed update daily',
    schedule_interval='0 0 * * *',
    start_date=days_ago(1),
    tags=['example']
)
def fear_and_greed_daily():
    ...
    def get_token():
        ...
        payload = {
            ...
            "exp": now + 3600,
            "iat": now,
            "target_audience": "https://asia-southeast1-cloudace-project-demo.cloudfunctions.net/fear-and-greed"
        }
    ...
    def invoke_cloud_function(id_token: str):
        url = 'https://asia-southeast1-cloudace-project-demo.cloudfunctions.net/fear-and-greed'
